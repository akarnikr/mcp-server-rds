...
This document breaks implementation into 6 executable phases. It is derived from:
- `docs/PRD.md`
...
- `docs/PHASE_6_HERO_SECTION_INGESTION.md`
...
5. Complete Phase 5 and pass all exit criteria before Phase 6.
6. Complete Phase 6 to reach implementation-ready and review-ready status.
